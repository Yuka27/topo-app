...
const Home = () => {
  ...
  <Typography color={grey[50]} variant="body2" sx={{marginTop: 2, marginLeft: 4, fontWeight: 'bold'}}>KONRAD MŁODZIK: 792 050 226</Typography>
  <Typography color={grey[400]} variant="body2" sx={{marginTop: 2, marginLeft: 4}}>KLAUDIA JEZIORSKA: 737 357 717</Typography>
  <Typography color={grey[400]} variant="body2" sx={{marginTop: 2, marginLeft: 4}}>WOJCIECH PIEPER: 666 884 263</Typography>
  <Typography color={grey[400]} variant="body2" sx={{marginTop: 2, marginLeft: 4}}>ARTUR WOŹNIAK: 695 324 539</Typography>
  </Box>
};
